...
export const networks = {
  testnet: {
    ...
    contractId: "CATB7Q7TG3Z3C2ZQMFLQW5MXQKE6XFUBG2UW563MRWY6JUT35DU7CTL3",
  }
} as const
...
export type DataKey = {tag: "Config", values: void} | {tag: "ProjectIds", values: void} | {tag: "Project", values: readonly [u32]} | {tag: "Donors", values: readonly [u32]} | {tag: "Contribution", values: readonly [u32, string]} | {tag: "Verified", values: readonly [string]} | {tag: "SumSqrt", values: readonly [u32]};
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
