...
export const fil: Strings = {
  ...
  landing: {
    ...
    heroLede:
      "Ang Rp50rb mula sa maraming perantau ay hindi lang donasyon. Sa Patungan, bawat kontribusyon ay pampublikong senyales na humihila ng pondo ng sponsor sa mga proyektong pinakasuportado ng nayon.",
